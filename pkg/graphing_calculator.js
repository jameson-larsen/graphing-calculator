...
* @param {number} y_end
*/
export function run(x_start, x_end, y_start, y_end) {
    wasm.run(x_start, x_end, y_start, y_end);
}
...
* @returns {any}
*/
export function initialize(expressions) {
    const ret = wasm.initialize(addHeapObject(expressions));
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_scale_202bd3c19df51811 = function() { return handleError(function (arg0, arg1, arg2) {
    ...
    imports.wbg.__wbg_canvas_35cc161df016f2dd = function(arg0) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('graphing_calculator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
